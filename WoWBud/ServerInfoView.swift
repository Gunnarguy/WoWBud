...
struct ServerInfoView: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            .padding(.horizontal)
            .padding(.bottom)
            .onChange(of: selectedServerType) { _ in
            ...
            VStack(alignment: .leading, spacing: 20) {
                ...
                VStack(alignment: .leading, spacing: 12) {
                    ...
                    VStack(alignment: .leading, spacing: 8) {
                        featureRow(icon: "calendar", title: "Launched", description: "November 21, 2024")
                        
                        if server.type == .hardcore {
                            featureRow(icon: "exclamationmark.triangle", title: "Character Death", description: "Permanent - One life only")
                            featureRow(icon: "arrow.left.arrow.right", title: "Character Transfer", description: "Allowed to PvE after death")
                            featureRow(icon: "clock.arrow.circlepath", title: "End State", description: "Remains in Classic Era")
                        } else {
                            featureRow(icon: "bolt.horizontal", title: "Progression", description: "Classic → The Burning Crusade")
                            featureRow(icon: "person.2", title: "Dual Spec", description: "Available (coming soon)")
                            featureRow(icon: "shield.checkerboard", title: "Buff Limits", description: "Removed for modern experience")
                        }
                        
                        featureRow(icon: "envelope", title: "Mail Delivery", description: "Instant between alt characters")
                    }
                }
                .padding()
                .background(Color(.secondarySystemBackground))
    ...
    private func loadServerData() {
        ...
        servers = [
            ...
            ClassicServer(id: 3, name: "Doomhowl", type: .hardcore, region: .us, population: "Medium"),
            
            // EU Servers
            ClassicServer(id: 4, name: "Thunderstrike", type: .pve, region: .eu, population: "High"),
            ClassicServer(id: 5, name: "Spineshatter", type: .pvp, region: .eu, population: "Full"),
            ClassicServer(id: 6, name: "Soulseeker", type: .hardcore, region: .eu, population: "Medium"),
