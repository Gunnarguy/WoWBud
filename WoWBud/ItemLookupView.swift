...
struct ItemLookupView: View {
    ...
    private let phase1Items: [ClassicItemPreview] = [
        ClassicItemPreview(id: 18832, name: "Brutality Blade", quality: 4, iconName: "inv_sword_43"),
        ClassicItemPreview(id: 18803, name: "Finkle's Lava Dredger", quality: 4, iconName: "inv_hammer_22"),
        ClassicItemPreview(id: 18814, name: "Choker of the Fire Lord", quality: 4, iconName: "inv_jewelry_necklace_07"),
        ClassicItemPreview(id: 18821, name: "Quick Strike Ring", quality: 4, iconName: "inv_jewelry_ring_24"),
        ClassicItemPreview(id: 16800, name: "Arcanist Crown", quality: 4, iconName: "inv_helmet_66"),
        ClassicItemPreview(id: 16858, name: "Lawbringer Chestguard", quality: 4, iconName: "inv_chest_plate03"),
        ClassicItemPreview(id: 16865, name: "Breastplate of Might", quality: 4, iconName: "inv_chest_plate16"),
        ClassicItemPreview(id: 18264, name: "Plans: Elemental Sharpening Stone", quality: 1, iconName: "inv_scroll_03")
    ]
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            HStack {
                ...
                // Search text field
                TextField(searchMode == .itemID ? "Enter Item ID" : "Enter Item Name", text: $searchText)
                    .padding(8)
    ...
    private func simulateItemLoad(id: Int) {
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + 0.8) {
            ...
            if let mockItem = mockItem {
                ...
                // Add to recent items
                self.addToRecentItems(ClassicItemPreview(
                    id: mockItem.id,
                    name: mockItem.name,
    ...
    private func createMockDetailedItem(from preview: ClassicItemPreview) -> ClassicItem {
        ...
        case 16800: // Arcanist Crown
            ...
            itemSpells = ["Set: (8) pieces - Increases the critical strike damage bonus of your Arcane and Fire spells by 3%."]
        ...
        case 16858: // Lawbringer Chestguard
            ...
            itemSpells = ["Set: (8) pieces - Your Flash of Light has a 25% chance to restore 60 mana when cast."]
            sources = ["Molten Core - Various bosses"]
        ...
        case 16865: // Breastplate of Might
            ...
            itemSpells = ["Set: (8) pieces - Your Defensive Stance now reduces damage taken by an additional 5%."]
            sources = ["Molten Core - Various bosses"]
